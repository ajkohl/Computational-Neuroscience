...
data_dir = os.path.join(utils.results_path, "12-real-time/data/")
...
switch_ROI = 0.5 # Do you want to switch the ROIs over part way through 
...
dimensions = np.array(template.shape[:3])
